    ...
    >
      ...
      >
        ...
        <div className="relative z-20">
          <a
            href="#contact"
            className="px-2 py-2 rounded-md bg-white text-black text-sm font-bold cursor-pointer hover:-translate-y-0.5 transition duration-200 inline-block text-center shadow-lg"
          >
            Contato
          </a>
        </div>
      ...
      >
        <div className="flex w-full flex-row items-center justify-between">
          ...
          <Link
            href="/"
            className="relative z-20 flex items-center space-x-2 px-2 py-1 text-lg"
          >
            <div className="flex items-center font-semibold text-white">
          ...
          {isMobileMenuOpen && (
            ...
            >
              ...
              <div className="w-full px-4 pt-4">
                <a
                  href="#contact"
                  className="block w-full px-4 py-3 rounded-md bg-white text-black text-center font-bold hover:bg-gray-100 transition-colors"
                >
                  Contato
                </a>
              </div>
